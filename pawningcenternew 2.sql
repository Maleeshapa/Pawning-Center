...
INSERT INTO `products` (`id`, `recepitNo`, `customerName`, `nic`, `address`, `phone`, `startDate`, `endDate`, `itemCategory`, `itemModel`, `itemName`, `itemNo`, `size`, `marketValue`, `estimateValue`, `monthlyInterest`, `totalInterest`, `totalPrice`, `customerPaid`, `dueAmount`, `status`, `buyerName`, `buyerNic`, `buyerAddress`, `buyerPhone`, `sellDate`, `sellPrice`) VALUES
(3, '3', 'abc', 'abc', 'abc', 'abc', '2024-09-09', NULL, 'Phone', 'Samsung', 'abc', 'abc', 'abc', 50000, 50000, NULL, 0, NULL, 0, 0, 'Removed', NULL, NULL, NULL, NULL, NULL, NULL),
(4, '3', 'xyz', 'xyz', 'xyz', 'xyz', '2024-09-18', NULL, 'Vehicle', 'Toyoto', 'xyz', 'xyz', 'xyz', 60000, 70000, NULL, 0, NULL, 0, 0, 'Sold', 'uuu', 'uuu', 'uuu', 'uuu', '2024-10-12', 90000);
